...
mlflow.set_tracking_uri("https://dagshub.com/aamirbstele/mlops_video14.mlflow")   # Registry URI for model management

# Load the dataset from CSV file and split into training and testing sets
data = pd.read_csv("/home/aamir/Downloads/water_potability.csv")
